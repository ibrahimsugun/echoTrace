...
class SoundSourceLocalization3D(QMainWindow):
    def __init__(self):
        ...
        self.setGeometry(100, 100, 1500, 900)  # Pencere boyutunu belirler
    ...
    def add_random_sound_source(self):
        ...
        self.noise_info_layout.addWidget(self.source_info_label)
    ...
    def clear(self):
        ...
        Ayrıca Ambient Gürültü Bilgisi alanındaki ses kaynağı etiketini kaldırır.
        """
        ...
        # Tahmin edilen ses kaynağı bilgisi etiketini kaldır
    ...
    def update_plot_elements(self):
        ...
        if self.estimated_point is not None:
            ...
            self.estimated_text = self.ax.text(
                x, y, z + offset,
                f'Tahmin (dB: {self.estimated_D:.2f})', color='green', fontsize=9,
                ha='left', va='bottom'
            )
